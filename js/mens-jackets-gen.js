...
async function getProducts(url) {
  ...
  products.forEach(product => {
    ...
    mensJacketsGenerator(productId, productName, productImg, productPrice, productType);
  });
}
getProducts(baseUrl);
...
function mensJacketsGenerator(productId, productName, productImg, productPrice, productType) {

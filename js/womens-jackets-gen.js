...
async function getProducts(url) {
  ...
  products.forEach(product => {
    ...
    womensJacketsGenerator(productId, productName, productImg, productPrice, productType);
  });
}
getProducts(baseUrl);

const womenProductsWrapper = document.querySelector('.womens-jackets');

function womensJacketsGenerator(productId, productName, productImg, productPrice, productType) {
  ...
  if (productType[0] === 'womens-jackets') {
